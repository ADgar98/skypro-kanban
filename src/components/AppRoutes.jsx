    ...
    <Routes>
      <Route element={<PrivateRoute />}>
        <Route
          path="/"
          element={
            <MainPage setCards={setCards} cards={cards} newToken={newToken} />
          }
        >
      ...
      <Route
        path="/signIn"
        element={<SignInPage setIsAuth={setIsAuth} setNewToken={setNewToken} />}
      />
      <Route
        path="/signUp"
        element={<SignUpPage setIsAuth={setIsAuth} setNewToken={setNewToken} />}
      />
